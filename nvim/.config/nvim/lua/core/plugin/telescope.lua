...
return {
  {
    ...
    keys = {
      ...
      { "<leader>fr",  "<cmd>Telescope lsp_references<cr>",      desc = "Telescope Hovered References (Telescope)" },
      ...
      -- { "<leader>fe", "<cmd>Telescope treesitter<cr>", desc = "Telescope Treesitter (Telescope)" },  -- TODO: does not seem to work
